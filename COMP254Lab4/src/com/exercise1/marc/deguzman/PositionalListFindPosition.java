 ...
 *
 * PositionalList implementation based from LinkedPositionalList
 */

public class PositionalListFindPosition<E> implements PositionalList<E> {
	//---------------- nested Node class ----------------
	/**
	...
	public PositionalListFindPosition() {
	...
	private class PositionIterator implements Iterator<Position<E>> {
		...
		public void remove() throws IllegalStateException {
			...
			PositionalListFindPosition.this.remove(recent);         // remove from outer list
	...
	public Position<E> findPosition(E elementItem) {
		Position<E> elementPosition = null;

		Node<E> walk = header.getNext();

		while (walk != trailer) {
			E currentItemElement = walk.getElement();

			// check element equality
			if (currentItemElement.equals(elementItem)) {
				elementPosition = walk;
				break;
			}
	...
	public static void main(String[] args) {
		// LinkedPosition of String
		PositionalListFindPosition<String> l1 = new PositionalListFindPosition<String>();
		// addFirst
		Position<String> p1 = l1.addFirst("aaa");
		// addLast
		l1.addLast("zzz");
		// addBetween
		l1.addBetween("bbb", (Node<String>) p1, l1.header.next.next);

		// call the toString() of the LinkedPositionalList
		System.out.println("l1 value: " + l1.toString());

		// findPosition(e); String
		String stringToFind = "aaa"; // string to find for position
		Position<String> findPositionByString = l1.findPosition(stringToFind);

		if (findPositionByString != null) {
			System.out.println("position found: " + findPositionByString.getElement());
		} else {
			System.out.println("position of " + stringToFind + " not found");
		}

		// LinkedPosition of Integer
		PositionalListFindPosition<Integer> l2 = new PositionalListFindPosition<Integer>();
		// addFirst
		Position<Integer> pInt1 = l2.addFirst(2);
		// addLast
		l2.addLast(6);
		// addBetween
		l2.addBetween(4, (Node<Integer>) pInt1, l2.header.next.next);

		// call the toString() of the LinkedPositionalList
		System.out.println("l2 values: " + l2.toString());

		// findPosition(e) Integer
		Integer integerToFind = 6; // integer to find for position
		Position<Integer> findPositionByInteger = l2.findPosition(integerToFind);

		if (findPositionByInteger != null) {
			System.out.println("position found: " + findPositionByInteger.getElement());
		} else {
			System.out.println("position of " + integerToFind + " not found");
		}
	}
}
