...
public class TreeMap<K,V> extends AbstractSortedMap<K,V> {
  ...
  /** Lab 7 exercise 1 treeSearch loop **/
  private Position<Entry<K,V>> treeSearchLoop(Position<Entry<K,V>> p, K key) {
	  Position<Entry<K,V>> walk = p;
	  ...
	  while(isInternal(p)) {
		  ...
		  int compareResult = compare(key, walk.getElement());
		  ...
		  {
			  walk = left(walk);	// search left subtree
		  }
		  else
		  {
			  walk = right(walk);	// search right subtree
		  }
	  }
  ...
  public static void main (String[] args)
  {
	  ...
	  TreeMap<Integer, String> aMap = new TreeMap<Integer,String>();
	  ...
	  // treeSearchLoop starting from root
	  Position<Entry<Integer, String>> mapFound = aMap.treeSearchLoop(aMap.root(), 30);
	  
	  if (mapFound != null) {
		  System.out.println("map item 30 found -> " + mapFound.getElement());
	  }
	  else {
		  System.out.println("map item 30 not found");
	  }
	  
	// treeSearchLoop starting from root
	  Position<Entry<Integer, String>> mapFound2 = aMap.treeSearchLoop(aMap.root(), 60);

	  if (mapFound2 != null) {
		  System.out.println("map item found -> " + mapFound2.getElement());
	  }
	  else {
		  System.out.println("map item 60 not found");
	  }
  }
}
